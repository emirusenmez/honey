...
<head>
    ...
    <title>oasispazar.com - Favoriler</title>
</head>
...
<body>
    ...
    <div class="banner">
        <div class="detail">
            <h1>Favoriler</h1>
            <a href="index.php">Ana Sayfa</a><span>/ Favoriler</span>
        </div>
    </div>
    <div class="line"></div>
    <!-----------------------about us------------------------>
    <section class="shop">
        ...
        <div class="wishlist_total">
            ...
            <a href="wishlist.php?delete_all" class="btn <?php echo ($grand_total)?'':'disabled'?>" onclick="return confirm('do you want to delete all items in your wishlist')">Tümünü sil</a>
        </div>
    </section>
